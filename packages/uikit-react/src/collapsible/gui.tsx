...
import { Collapsible as ArkCollapsible, type CollapsibleContentProps, type CollapsibleRootProps, type CollapsibleTriggerProps} from '@ark-ui/react/collapsible'
import { recipeGuiCollapsible, type GuiCollapsibleContentVariantsProps, type GuiCollapsibleContainerVariantsProps, type GuiCollapsibleTriggerVariantsProps, recipeGuiExpandable } from "@happy.tech/design-system";
import { cx } from "cva";
...
export const GuiTrigger = forwardRef<HTMLButtonElement, GuiTriggerProps>(
  ({ className = '',  scale, children, ...props }, ref) => (
    ...
    <ArkCollapsible.Trigger
      ref={ref}
      className={cx(recipeGuiCollapsible.trigger({ scale }), className)}
      {...props}
    >
        {children}
...
export const GuiContent = forwardRef<HTMLDivElement, GuiContentProps>(
  ({ className = '', scale, ...props }, ref) => (
    <ArkCollapsible.Content
      ref={ref}
      className={recipeGuiCollapsible.content({ scale })}
      {...props}
    />
  )
)
