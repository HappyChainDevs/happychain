import {
    type GuiAlertActionsVariantsProps,
    type GuiAlertDescriptionVariantsProps,
    type GuiAlertIconVariantsProps,
    type GuiAlertTitleVariantsProps,
    recipeGuiAlert,
...
export const GuiContainer = forwardRef<HTMLDivElement, GuiAlertContainerProps>((props, ref) => {
    const { className = "", intent, scale, aspect, children, ...rest } = props
