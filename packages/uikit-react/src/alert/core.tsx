...
const Root = forwardRef<HTMLDivElement, AlertRootProps>((props, ref) => {
    const { intent = "default", scale = "default", aspect = "default", children, ...rest } = props
...
const Icon = forwardRef<HTMLDivElement, AlertIconProps>((props, ref) => {
    ...
    return (
        <ark.div ref={ref} data-scope="alert" data-part="icon" {...rest}>
            {children}
        </ark.div>
    )
})
...
const Title = forwardRef<HTMLDivElement, AlertTitleProps>((props, ref) => {
    ...
    return (
        <ark.h1 ref={ref} id={titleId} data-scope="alert" data-part="title" {...rest}>
            {children}
        </ark.h1>
    )
})
...
const Description = forwardRef<HTMLDivElement, AlertDescriptionProps>((props, ref) => {
    ...
    return (
        <ark.p ref={ref} data-scope="alert" data-part="description" {...rest}>
            {children}
        </ark.p>
    )
})
...
const Actions = forwardRef<HTMLDivElement, AlertActionsProps>((props, ref) => {
    ...
    return (
        <ark.div ref={ref} data-scope="alert" data-part="actions" {...rest}>
            {children}
        </ark.div>
    )
})
...
const TriggerAction = forwardRef<HTMLButtonElement, AlertTriggerActionProps>((props, ref) => {
    ...
    return (
        <ark.button ref={ref} data-scope="alert" data-part="trigger" {...rest}>
            {children}
        </ark.button>
    )
})
