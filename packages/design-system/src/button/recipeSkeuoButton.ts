...
export const recipeSkeuoButton = {
    ...
    recess: cva({
      base: [
        "block size-full absolute inset-0",
        "mix-blend-overlay",
        "opacity-55",
      ],
      variants: {
    ...
    interactiveElement: cva({
      base: [
        "cursor-pointer",
        "absolute z-10 block inset-0 size-full",
        "sr-only"
      ],
...
export type SkeuoButtonVariantsProps = 
  VariantProps<typeof recipeSkeuoButton.cuttout> & 
