    ...
    "p-0 group cursor-pointer focus-within:ring-2 rounded-lg items-center [&_svg]:open:-rotate-180 [&_svg]:transition",
    {
        variants: {
            intent: {
                ...
                neutral: "bg-base-content text-neutral shadow border border-neutral rounded-lg",
                developerInfo: "",
            },
        },
        defaultVariants: {
...
const recipeDisclosureContent = cva("px-4 py-2 text-xs overflow-x-auto group-open:overflow-x-auto", {
    variants: {
        intent: {
            default: "",
            gradient: "",
            neutral: "bg-base-content text-neutral border-t border-neutral shadow-sm rounded-b-lg",
        },
    },
    defaultVariants: {
        intent: "default",
