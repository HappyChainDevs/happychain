...
export const publicClientAtom = atom(createPublicClient({ transport: custom(DEFAULT_PROVIDER) }))
...
// utils
export const makeAccountWalletClient = (account: `0x${string}`, provider: Parameters<typeof custom>[0]) =>
