...
contract HappyEntryPointGasEstimator is Test {
    ...
    // ====================================================================================================
    // READY-TO-SUBMIT HAPPY TXs (// TODO: Remove this once above tx creation code works)
    ...
    function _getSelfPayingHappyTx() internal pure returns (HappyTx memory) {
        return HappyTx({
            ...
            //             hex"4968cd6eabdbd01cd887a5974e97bbd9a133a3a5a4c9041125f1e22b7612dd260f0f18e7a4dd19da64aa4b7992425726df4026206fe9ba4c0e13831dea1102f51b",
            extraData: hex""
        });
    }
