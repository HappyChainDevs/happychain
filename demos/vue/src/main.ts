...
export const config = createHappyChainWagmiConfig(getChain(import.meta.env.HAPPY_CHAIN_ID)) as WagmiConfig

createApp(App)
    .use(HappyChainPlugin, { chainId: import.meta.env.HAPPY_CHAIN_ID })
