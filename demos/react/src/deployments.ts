...
export const deployment = Number(import.meta.env.VITE_CHAIN_ID) === anvil.id ? anvilDeployments : sepoliaDeployments
export const abis = Number(import.meta.env.VITE_CHAIN_ID) === anvil.id ? anvilAbis : sepoliaAbis
