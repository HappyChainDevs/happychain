...
const recipeInput = cva(
    [
        ...
        // State: error
        "input-invalid:bg-error/15 input-invalid:border-error/60 input-invalid:content-focused:ring-2 input-invalid:ring-error/60",
        // State: error (dark mode)
        "dark:input-invalid:bg-error/5 dark:input-invalid:border-error/30  dark:input-invalid:bg-error/[0.08]",
    ],
    {
        variants: {
            intent: {
