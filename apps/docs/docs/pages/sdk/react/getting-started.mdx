...
```ts [Viem] twoslash
import { happyProvider } from '@happy.tech/react' 
...
```ts twoslash
import { onUserUpdate } from '@happy.tech/react'
...
```ts twoslash
import { getCurrentUser } from '@happy.tech/react'
...
```ts twoslash
import { type HappyUser, getCurrentUser, onUserUpdate } from '@happy.tech/react'
