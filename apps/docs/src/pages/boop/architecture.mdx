...
Ideally, we don't want the user to maintain balances on both his smart account and an EOA to pay fees.
...
- A device form which the user wants to make transactions.
