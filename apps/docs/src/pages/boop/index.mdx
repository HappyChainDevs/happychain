...
also not a design goal of Boop to support an open mempool (though it's not particularly difficult to set one up, the
open aspect brings up a lot of extra considerations).
