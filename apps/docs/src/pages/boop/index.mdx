...
There's surprisingly little trade-offs involved. The main one compared to ERC-4337 is
we have less restrictions aimed at preventing infrastructure operators from taking
losses. In practice, both ERC-4337 and Boop need to rely on reputation heuristics and paymaster staking
