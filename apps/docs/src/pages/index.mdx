...
These are open-source (or to-be open-sourced) tools and utilities that we build for our internal
needs but make available to everyone. Application builders most likely won't need those.

- [TXM (Transaction Manager)] — Our WIP transaction manager, which makes submitting transactions super reliable
...
- [Randomness] — A service that provides a secure and reliable source of randomness for your blockchain applications.
