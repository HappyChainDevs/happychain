...
- **Gas Token**: $HAPPY, bridged from ETH on Ethereum Sepolia*

⚠️**IMPORTANT**: The RPC URLs should not be used for apps that leverage the [Happy Wallet], instead you should
setup your Viem/Ethers/... clients with our provider, as [described here][wallet-usage].

[Happy Wallet]: https://master.happychain.pages.dev/sdk
[wallet-usage]: https://master.happychain.pages.dev/sdk/js#usage

\* $HAPPY will be its own token on mainnet, but for the first testnet, it is bridged 1-1 from SepoliaETH.
