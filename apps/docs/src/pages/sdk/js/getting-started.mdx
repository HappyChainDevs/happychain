...
Once you have installed the SDK, you will need to initialize the wallet component on the page. 
The easiest way to accomplish this is by using our provided [`loadHappyWallet`] method.
...
{/*
```js [CDN]
window.HappyChain.loadHappyWallet()
```
*/}
