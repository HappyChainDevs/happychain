...
```ts [Viem]
import { createHappyPublicClient, createHappyWalletClient } from "@happy.tech/core/viem"
...
If the `user` is a [HappyUser](/sdk/js/api/index/type-aliases/HappyUser) then it will be populated with all their
shared info, such as wallet address and name.

[`onUserUpdate`]: /sdk/js/api/index/functions/onUserUpdate
...
[`getCurrentUser`]: /sdk/js/api/index/function/getCurrentUser
...
[`connect()`]: /sdk/js/api/index/functions/connect
[`disconnect()`]: /sdk/js/api/index/functions/disconnect
[`openWallet()`]: /sdk/js/api/index/functions/openWallet
[`loadAbi(abi: Abi)`]: /sdk/js/api/index/functions/loadAbi
...
[`requestSessionKey(contract: Address)`]: /sdk/js/api/index/functions/requestSessionKey
...
[`register`]: /sdk/js/api/index/functions/register
...
- [`happychainSepolia](/sdk/js/api/index/variables/happyChainSepolia)
