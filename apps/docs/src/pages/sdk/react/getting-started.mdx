...
[`createHappyChainWagmiConfig`]: /sdk/js/api/index/functions/createHappyChainWagmiConfig
[`happyWagmiConnector`]: /sdk/js/api/index/functions/happyWagmiConnector
...
[`HappyUser`]: /sdk/js/api/index/type-aliases/HappyUser
