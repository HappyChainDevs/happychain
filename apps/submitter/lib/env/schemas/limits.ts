...
export const limitsSchema = z.object({
     ...
     * waiting for previous transactions to be submitted or a nonce gap to close). Defaults to 4 seconds.
     */
    MAX_BLOCKED_TIME: z.coerce.number().positive().default(4_000),
