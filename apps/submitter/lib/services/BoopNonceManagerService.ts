...
export class BoopNonceManagerService {
    ...
    readonly #blockedTxMap: Map2<Address, NonceTrack, Map<NonceValue, BlockedBoop>>
     ...
     */
    getBlockedBoops(account: Address): PendingBoopInfo[] {
    ...
    #getMaxNonce(currentNonce: bigint) {
